<%@Page Title ="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"  CodeFile="CheckDiagnosesillness.aspx.cs" Inherits="CheckDiagnosesillness" %>
              ...
              <asp:MultiView runat="server" ID="mltView" ActiveViewIndex="0">
                <asp:View ID="View" runat="server">
                      <fieldset id="Fieldset" runat="server" style="height:700px">
                          <legend style="color:orangered;text-align:left"><b>VIEW PREVIOUS DIAGNOSES OR ILLNESS</b></legend>
                          ...
                          <tr>
                              ...
                              <td style="text-align:left" class="auto-style2"><asp:TextBox ID="TxtPatientNumber" runat="server" ></asp:TextBox></td>
                                 ...
                                 <td  style="text-align:left">
                                    <asp:Button ID="btnSubmit" Text="SEARCH" runat="server" OnClick="btnSearchIllness_Click"></asp:Button>
