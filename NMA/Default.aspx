          ...
          <td style="width:50%;">
              <asp:MultiView runat="server" ID="mltView" ActiveViewIndex="0">
                  <asp:View runat="server">
                      <fieldset runat="server" style="height:700px">
                      ...
                      <table style="width:100%" border="0">
                          ...
                          <tr>
                                <td style="width:45%;text-align:right"><asp:Label ID="Label10" Text="Telephone1" runat="server"></asp:Label></td>
                                <td style="width:5px;text-align:center"><asp:Label ID="Label11" Text=":" runat="server"></asp:Label></td>
                                <td style="text-align:left"><asp:TextBox ID="txtTelephone1" runat="server"></asp:TextBox></td>
                          </tr>
                           <tr style="height:10px">
                              <td colspan="3">
                          ...
                          <tr>
                                <td style="width:45%;text-align:right"><asp:Label ID="Label12" Text="Telephone2" runat="server"></asp:Label></td>
                                <td style="width:5px;text-align:center"><asp:Label ID="Label13" Text=":" runat="server"></asp:Label></td>
                                <td style="text-align:left"><asp:TextBox ID="txtTelephone2" runat="server"></asp:TextBox></td>
                          </tr>
                           <tr style="height:10px">
                              <td colspan="3">
                  ...
                  <asp:View ID="View1" runat="server">
                      ...
                      <table style="width:100%" border="0">
                          ...
                          <tr>
                                <td style="width:45%;text-align:right"><asp:Label ID="Label14" Text="Blood Type" runat="server"></asp:Label></td>
                                <td style="width:5px;text-align:center"><asp:Label ID="Label15" Text=":" runat="server"></asp:Label></td>
                                <td style="text-align:left"><asp:TextBox ID="txtBloodType" runat="server"></asp:TextBox></td>
                          </tr>
                           <tr style="height:10px">
                              <td colspan="3">
                          ...
                          <tr style="height:10px">
                           ...
                           <tr>
                                <td style="width:45%;text-align:right"><asp:Label ID="Label22" Text="Blood Suger" runat="server"></asp:Label></td>
                          ...
                          <tr>
                                <td colspan="2"></td>
                                <td style="text-align:left">
                                    <asp:Button ID="btnView3" Text="  NEXT  " runat="server" OnClick="btnView3_Click"></asp:Button>
